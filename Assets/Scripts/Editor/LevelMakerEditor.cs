...
public class LevelMakerEditor : EditorWindow
{
    ...
    void OnFocus()
    {
        ...
        {
            GameManager lm = GameManager.Instance;
    ...
    void GUIAds()
    {
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobUIDAndroid = EditorGUILayout.TextField("Admob ID Android ", initscript.admobUIDAndroid, new GUILayoutOption[] {
            GUILayout.Width (220),
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobUIDIOS = EditorGUILayout.TextField("Admob ID iOS", initscript.admobUIDIOS, new GUILayoutOption[] {
            GUILayout.Width (220),
            GUILayout.MaxWidth (220)
        });
        GUILayout.EndHorizontal();
        ...
        foreach (AdEvents item in initscript.adsEvents)
        {
            ...
            /*var state = EditorGUILayout.EnumPopup(item.gameEvent.name, new GUILayoutOption[] { GUILayout.Width(100) });
            item.gameEvent = GameManager.Instance.GetState<>();/*/
    ...
    void GUIHelp()
    {
        GUILayout.Label("Jelly Garden Match 3 Complete Project + EDITOR v 2.3.2", EditorStyles.boldLabel, new GUILayoutOption[] { GUILayout.Width(400) });
...
//        }
    ...
    {
        var asset = Resources.Load<TargetLevel>("Targets/Level" + levelNumber);
        if (asset == null)
        {
